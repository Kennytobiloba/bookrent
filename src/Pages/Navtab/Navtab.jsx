...
const StyledTab = styled(Tab)`
  &.MuiButtonBase-root {
    border-radius: 9999px; /* TailwindCSS class rounded-full equivalent */
    margin: 0 8px; /* Add some margin between buttons */
    padding: ;
  }
  &.Mui-selected {
    background-color: #ef4444; /* TailwindCSS class bg-red-500 equivalent */
...
const Navtab = () => {
  ...
  return (
    <Box className="flex flex-col items-start justify-start mt-6 p-6 w-full text-justify ">
      <Tabs
        value={value}
      ...
      >
        ...
        <StyledTab label="Author" />
        <StyledTab label="Comment" />
        <StyledTab label="Review" />
      </Tabs>
      <Box className="mt-4 w-full lg:w-[90%]">
        {value === 0 && (
          <Box>
            <p className='mt-6'>
            ...
            <p className='mt-6'>
              ...
              Divorce and the death of spouses or grown children leaving for
