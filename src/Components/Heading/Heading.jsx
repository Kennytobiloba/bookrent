...
const Heading = () => {
  ...
  const suggestions = ["J.K. Rowling", "George R.R. Martin", "J.R.R. Tolkien", "Stephen King"];
        ...
        flex-wrap md:flex-nowrap lg:gap-10 gap-4 md:gap-4">
          ...
          <div className="relative flex md:w-[40%] w-full  h-14 border rounded-[30px] border-gray-200 items-center p-6">
            <input 
              ...
              onBlur={handleBlur}
            />
            <CiSearch size={32} className="text-red-500" />
            {showSuggestions && (
          ...
          <div className="flex justify-between items-center mx-auto md:mx-0 text-[14px] 
           md:gap-4  lg:gap-4 2xl:text-[18px] md:text-[16px] gap-4 sm:gap-12  sm:text-[16px]
            ...
            <div className="relative">
              <IoCartOutline  className="2xl:text-[38px] text-[30px] " />
            ...
            <button className="bg-red-500 text-white font-bold flex
             md:px-6 md:py-4 lg:py-4 lg:px-10 lg:text-[18px] rounded-full sm:text-[14px] text-[12px] px-8 py-4">
              Sign In
            </button>
          </div>
        </div>
